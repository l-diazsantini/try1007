...
import 'device_page_copy_widget.dart' show DevicePageCopyWidget;
...
class DevicePageCopyModel extends FlutterFlowModel<DevicePageCopyWidget> {
  ...
  // Stores action output result for [Custom Action - getRssi] action in DevicePageCopy widget.
  int? updatedRssi;
