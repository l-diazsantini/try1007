...
import 'device_page_copy_model.dart';
export 'device_page_copy_model.dart';

class DevicePageCopyWidget extends StatefulWidget {
  const DevicePageCopyWidget({
    super.key,
  ...
  @override
  State<DevicePageCopyWidget> createState() => _DevicePageCopyWidgetState();
}

class _DevicePageCopyWidgetState extends State<DevicePageCopyWidget> {
  late DevicePageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DevicePageCopyModel());
