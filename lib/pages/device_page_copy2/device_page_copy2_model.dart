...
import 'device_page_copy2_widget.dart' show DevicePageCopy2Widget;
...
class DevicePageCopy2Model extends FlutterFlowModel<DevicePageCopy2Widget> {
  ...
  // Stores action output result for [Custom Action - getRssi] action in DevicePageCopy2 widget.
  int? updatedRssi;
