...
import 'device_page_copy2_model.dart';
export 'device_page_copy2_model.dart';

class DevicePageCopy2Widget extends StatefulWidget {
  const DevicePageCopy2Widget({
    super.key,
  ...
  @override
  State<DevicePageCopy2Widget> createState() => _DevicePageCopy2WidgetState();
}

class _DevicePageCopy2WidgetState extends State<DevicePageCopy2Widget> {
  late DevicePageCopy2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DevicePageCopy2Model());
